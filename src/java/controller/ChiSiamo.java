...
public class ChiSiamo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * contenente la descizione chi siamo 
         * e indirizza alla jsp chi siamo*/
      FileReader reader=new FileReader("/Users/antonioranaudo/NetBeansProjects/JustVintage/web/css/chi siamo.txt");

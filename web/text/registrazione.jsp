<%-- 
    ...
    Created on : 13-giu-2018, 20.04.17
    Author     : Ferdinando
--%>
...
<script type="text/javascript">
    ...
    <body onload="alert('${mess}')">
     ...
     <c:otherwise>
					...
					<div class="products">
						<div class="title">
							...
							<img class="bullet" src="css/images/punto.gif" alt="small grey bullet" />
                                                ...
                                                <form class="registrazione" method="post" action="Registrazione">
                                                        <fieldset>
                                                            ...
                                                            <p>
                                                                ...
                                                                <input type="text" id="password" name="password" placeholder="compresa tra 5 e 45 caratteri" required value="" />
                                                            </p>
                                                            <p>
                                                                <label for="codFisc">Codice Fiscale</label>
                                                                <input type="text" id="codFisc" name="codFisc" placeholder="deve essere di 16 caratteri alfanumerici"required value="" />
                                                            </p>
                                                             <p>
                                                                <label for="iban">IBAN</label>
                                                                <input type="text" id="iban" name="iban" placeholder="deve essere di 27 caratteri alfanumerici" required value="" />
                                                            </p>
                                                             <p>
                                                                <label for="indirizzo">Indirizzo</label>
                                                                <input type="text" id="indirizzo" name="indirizzo" placeholder="es. via roma 45 23098 roma" required value="" />
                                                            </p>
		...
		<!-- Footer  -->
		<div id="footer">
                    <span class="author"><a><a title="Thank to Antonio Ranaudo" href="mailto:antonio.ranaudo@gmail.com">Thanks to Antonio Ranaudo</a></span>
                    <p><a title="Chi Siamo" href="ChiSiamo">Chi Siamo</a><span>&frasl;&frasl;</span><a title="Servizio Clienti" href="mailto:clienti@justvintage.com">Servizio Clienti</a>
		</div>
		<!-- END Footer -->
	</div>
</body>

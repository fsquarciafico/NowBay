<%-- 
    Document   : catalogo
    Created on : 13-giu-2018, 17.05.14
    Author     : Ferdinando
--%>
...
<script type="text/javascript">
    ...
    <body>
       <div class="shell">		
					...
					<!-- Products -->
						...
						<div class="title">
							...
							<img class="bullet" src="css/images/punto.gif" alt="small grey bullet" />
								...
								<div class="product">                                                                    
                                                                    <a title="More Details" href="Dett?c_prod=${item.cod_prod}"> <img src="${item.immagine}"/></a>
									<div class="desc">
										<p>${item.tipo_prod}</p>
                                                                                <p class="price"><span >&euro; </span>${item.prezzo}</p>
									</div>
		...
		<!-- Footer  -->
		<div id="footer">
                    <span class="author"><a><a title="Thanks to Ferdinando Squarciafico" href="mailto:f.squarciafico@gmail.com">Thanks to Ferdinando Squariafico</a></span>
